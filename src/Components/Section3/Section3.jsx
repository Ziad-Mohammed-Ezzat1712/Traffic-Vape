  ...
  const products = [
    {
      id: 1,
      brand: 'DKHAAN',
      title: 'Dkhaan Infinity Portable Hookah Nest',
      price: 'From 200 EGP',
      image: img5,
    },
    {
      id: 2,
      brand: 'SMYLE LABS',
      title: 'Smyle (DSPLY 20pc)(510BATT) Mini Plug',
      price: 'From 1000 EGP',
      image: img6,
    },
    {
      id: 3,
      brand: 'SMYLE LABS',
      title: 'Smyle (510BATT) Wandjamin Cart',
      price: 'From 350 EGP',
      image: img7,
    },
    {
      id: 4,
      brand: 'SMYLE LABS',
      title: 'Smyle (Lighter) Fyre Saber Shaped Torch',
      price: 'From 150 EGP',
      image: img8,
    },
  ];
